...
//        }
    ...
    private void postMySecretKeyInfo() {
        String url = API_URL + "/postSecretKeyInfoList";
    ...
    private void postBluetoothInfo() {
        String url = API_URL + "/postBluetoothInfoList";
    ...
    private void findRiskLevelByUserid() {
        String url = API_URL + "/findRiskLevelByUserid";
        ...
        HttpUtil.sendOkHttpRequest(url, requestBody, new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                float riskLevel = Float.parseFloat(responseText);
     ...
     * @param riskLevel
     */
    private void saveMyRiskLevel(float riskLevel) {
        SharedPreferences.Editor editor = PreferenceManager.getDefaultSharedPreferences(BluetoothActivity.this).edit();
        editor.putFloat("riskLevel", riskLevel);
        editor.apply();
    }
    ...
    public void getAndSaveOtherSK(){
        String url = API_URL + "/getSecretKeyList";
